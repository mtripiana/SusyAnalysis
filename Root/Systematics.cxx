...
void Systematics::LoadList(){
  ...
  m_CP_list.push_back("EL_SCALE_MOMENTUM__1up");   
  m_CP_list.push_back("EL_SCALE_MOMENTUM__1down");
  //**Flavor Tagging
  m_CP_list.push_back("FT_Eigen_B_0__1down");  
  m_CP_list.push_back("FT_Eigen_B_0__1up");  
  m_CP_list.push_back("FT_Eigen_B_1__1down");   
  m_CP_list.push_back("FT_Eigen_B_1__1up");   
  m_CP_list.push_back("FT_Eigen_B_2__1down");  
  m_CP_list.push_back("FT_Eigen_B_2__1up");  
  m_CP_list.push_back("FT_Eigen_B_3__1down");  
  m_CP_list.push_back("FT_Eigen_B_3__1up");  
  m_CP_list.push_back("FT_Eigen_B_4__1down");  
  m_CP_list.push_back("FT_Eigen_B_4__1up");  
  m_CP_list.push_back("FT_Eigen_B_5__1down");  
  m_CP_list.push_back("FT_Eigen_B_5__1up");  
  m_CP_list.push_back("FT_Eigen_B_6__1down");   
  m_CP_list.push_back("FT_Eigen_B_6__1up");   
  m_CP_list.push_back("FT_Eigen_B_7__1down");   
  m_CP_list.push_back("FT_Eigen_B_7__1up");   
  m_CP_list.push_back("FT_Eigen_B_8__1down");   
  m_CP_list.push_back("FT_Eigen_B_8__1up");   
  m_CP_list.push_back("FT_Eigen_B_9__1down");   
  m_CP_list.push_back("FT_Eigen_B_9__1up");   
  m_CP_list.push_back("FT_Eigen_C_0__1down");  
  m_CP_list.push_back("FT_Eigen_C_0__1up");  
  m_CP_list.push_back("FT_Eigen_C_1__1down");   
  m_CP_list.push_back("FT_Eigen_C_1__1up");   
  m_CP_list.push_back("FT_Eigen_C_2__1down");  
  m_CP_list.push_back("FT_Eigen_C_2__1up");  
  m_CP_list.push_back("FT_Eigen_C_3__1down");  
  m_CP_list.push_back("FT_Eigen_C_3__1up");  
  m_CP_list.push_back("FT_Eigen_Light_0__1down"); 
  m_CP_list.push_back("FT_Eigen_Light_0__1up"); 
  m_CP_list.push_back("FT_Eigen_Light_10__1down");   
  m_CP_list.push_back("FT_Eigen_Light_10__1up");   
  m_CP_list.push_back("FT_Eigen_Light_11__1down");   
  m_CP_list.push_back("FT_Eigen_Light_11__1up");   
  m_CP_list.push_back("FT_Eigen_Light_1__1down");    
  m_CP_list.push_back("FT_Eigen_Light_1__1up");    
  m_CP_list.push_back("FT_Eigen_Light_2__1down");    
  m_CP_list.push_back("FT_Eigen_Light_2__1up");    
  m_CP_list.push_back("FT_Eigen_Light_3__1down");   
  m_CP_list.push_back("FT_Eigen_Light_3__1up");   
  m_CP_list.push_back("FT_Eigen_Light_4__1down");    
  m_CP_list.push_back("FT_Eigen_Light_4__1up");    
  m_CP_list.push_back("FT_Eigen_Light_5__1down");   
  m_CP_list.push_back("FT_Eigen_Light_5__1up");   
  m_CP_list.push_back("FT_Eigen_Light_6__1down");    
  m_CP_list.push_back("FT_Eigen_Light_6__1up");    
  m_CP_list.push_back("FT_Eigen_Light_7__1down");   
  m_CP_list.push_back("FT_Eigen_Light_7__1up");   
  ...
  m_CP_list.push_back("JET_BJES_Response__1up");        
  m_CP_list.push_back("JET_BJES_Response__1down");        
  m_CP_list.push_back("JET_EffectiveNP_1__1up");        
  m_CP_list.push_back("JET_EffectiveNP_1__1down");        
  m_CP_list.push_back("JET_EffectiveNP_2__1up");        
  m_CP_list.push_back("JET_EffectiveNP_2__1down");        
  m_CP_list.push_back("JET_EffectiveNP_3__1up");        
  m_CP_list.push_back("JET_EffectiveNP_3__1down");        
  m_CP_list.push_back("JET_EffectiveNP_4__1up");        
  m_CP_list.push_back("JET_EffectiveNP_4__1down");        
  m_CP_list.push_back("JET_EffectiveNP_5__1up");        
  m_CP_list.push_back("JET_EffectiveNP_5__1down");        
  m_CP_list.push_back("JET_EffectiveNP_6restTerm__1up");        
  m_CP_list.push_back("JET_EffectiveNP_6restTerm__1down");        
  m_CP_list.push_back("JET_EtaIntercalibration_Modelling__1up");        
  m_CP_list.push_back("JET_EtaIntercalibration_Modelling__1down");        
  m_CP_list.push_back("JET_EtaIntercalibration_TotalStat__1up");        
  m_CP_list.push_back("JET_EtaIntercalibration_TotalStat__1down");        
  m_CP_list.push_back("JET_Flavor_Composition__1up");        
  m_CP_list.push_back("JET_Flavor_Composition__1down");        
  m_CP_list.push_back("JET_Flavor_Response__1up");        
  m_CP_list.push_back("JET_Flavor_Response__1down");        
  m_CP_list.push_back("JET_Pileup_OffsetMu__1up");        
  m_CP_list.push_back("JET_Pileup_OffsetMu__1down");        
  m_CP_list.push_back("JET_Pileup_OffsetNPV__1up");        
  m_CP_list.push_back("JET_Pileup_OffsetNPV__1down");        
  m_CP_list.push_back("JET_Pileup_PtTerm__1up");        
  m_CP_list.push_back("JET_Pileup_PtTerm__1down");        
  m_CP_list.push_back("JET_Pileup_RhoTopology__1up");        
  m_CP_list.push_back("JET_Pileup_RhoTopology__1down");        
  m_CP_list.push_back("JET_PunchThrough_MC12__1up");        
  m_CP_list.push_back("JET_PunchThrough_MC12__1down");        
  m_CP_list.push_back("JET_SingleParticle_HighPt__1up");        
  m_CP_list.push_back("JET_SingleParticle_HighPt__1down");        
  // JET_RelativeNonClosure_MC12 zero by construction (Steven Schramm)
  m_CP_list.push_back("JET_RelativeNonClosure_AFII__1up");
  m_CP_list.push_back("JET_RelativeNonClosure_AFII__1down");
  //**MET
  m_CP_list.push_back("MET_SoftCalo_Reso");    
  m_CP_list.push_back("MET_SoftCalo_ScaleDown");   
  m_CP_list.push_back("MET_SoftCalo_ScaleUp");    
  ...
  //**PHOTON
  m_CP_list.push_back("PH_SCALE_CONVEFFICIENCY__1up");    
  m_CP_list.push_back("PH_SCALE_CONVEFFICIENCY__1down"); 
  m_CP_list.push_back("PH_SCALE_CONVFAKERATE__1up");   
  m_CP_list.push_back("PH_SCALE_CONVFAKERATE__1down"); 
  m_CP_list.push_back("PH_SCALE_CONVRADIUS__1up");
  m_CP_list.push_back("PH_SCALE_CONVRADIUS__1down");   
  m_CP_list.push_back("PH_SCALE_LEAKAGECONV__1up");    
  m_CP_list.push_back("PH_SCALE_LEAKAGECONV__1down");    
  m_CP_list.push_back("PH_SCALE_LEAKAGEUNCONV__1up");    
  m_CP_list.push_back("PH_SCALE_LEAKAGEUNCONV__1down");
  //**TAU
  m_CP_list.push_back("TAUS_EFF_CONTJETID_STAT__1down");    
  m_CP_list.push_back("TAUS_EFF_CONTJETID_STAT__1up");    
  m_CP_list.push_back("TAUS_EFF_CONTJETID_SYST__1down");
  m_CP_list.push_back("TAUS_SME_TOTAL__1down");    
  m_CP_list.push_back("TAUS_SME_TOTAL__1up");    

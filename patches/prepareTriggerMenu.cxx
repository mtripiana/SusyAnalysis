...
namespace TrigConf {
   ...
   StatusCode prepareTriggerMenu( const xAOD::TriggerMenu* menu,
      ...
      for( size_t i = 0; i < menu->chainIds().size(); ++i ) {
	    ...
	    msg << MSG::WARNING << "AFTER CHAIN SIG TRIGGER" << endreq;	 
      ...
      if (menu->sequenceOutputTEsAvailable()) {
        ...
        msg << MSG::WARNING << "prepareTriggerMenu(...): sequenceOutputTEs not available" << endreq;

...
void do_sbottom_cutflow(TString sample="", bool isTruth=false){
  ...
  print(ch, "jpt1>50, |eta|<2.8", myvar, base+" && isGRL && isLarGood && isTileGood && !isTileTrip && !isCoreFlag "+trigCutSR+" && "+PVcut+" && !isBadID && isCosmic<2 && !isBadMuon && met["+metFlv+"]>100. && j_N>1 && j_N<5 && j_pt[1]>50.)");  
  print(ch, "jet veto (jpt4<50, |eta|<2.8)", myvar, base+" && isGRL && isLarGood && isTileGood && !isTileTrip && !isCoreFlag "+trigCutSR+" && "+PVcut+" && !isBadID && isCosmic<2 && !isBadMuon && met["+metFlv+"]>100. && j_N>1 && j_N<5 && j_pt[1]>50. && j_pt[3]<50.)");  
  ...
  //  print(ch, "2 leading bjets (MV2c20@77%)", myvar, base+" && isGRL && isLarGood && isTileGood && !isTileTrip && !isCoreFlag "+trigCutSR+" && "+PVcut+" && !isBadID && isCosmic<2 && !isBadMuon && met["+metFlv+"]>100. && j_N>1 && j_N<5 && j_pt[1]>50. && j_pt[3]<50. && "+nbjvar+"==2 && "+btag1+" && fabs(j_eta[0])<2.5 && (("+btag2+" && fabs(j_eta[1])<2.5) || (j_tag_MV2c20[2]>-0.4434 && fabs(j_eta[2])<2.5)))");    
